...
<head>
    <meta charset="UTF-8">
    <title>{{ __('Medical Referral') }} - Bulk Export</title>
    <style>
        @page {
    ...
    @foreach($employees as $employee)
        ...
        <div class="page-break">
            ...
            <div style="padding-left: 16px;">
                <table class="grid-table">
                    <tr>
                        ...
                        <td class="value-cell font-bold">{{ $employee->personalData?->last_name }} {{ $employee->personalData?->first_name }}</td>
                    </tr>
                    <tr>
                        <td class="label-cell">{{ __('Birth Date') }}:</td>
                        <td class="value-cell">{{ $employee->personalData?->date_of_birth ? \Carbon\Carbon::parse($employee->personalData->date_of_birth)->format('Y. m. d.') : '-' }}</td>
                    </tr>
                    <tr>
            ...
            <div class="mt-8 px-4 text-sm text-slate-600 italic" style="text-align: justify; line-height: 1.6;">
                <p>A fenti munkavállalót a munkaköri, szakmai, illetve személyi higiénés alkalmasság orvosi vizsgálatáról és véleményezéséről szóló 33/1998. (VI. 24.) NM rendelet alapján beutalom alkalmassági vizsgálatra.</p>
            </div>
            ...
            <!-- Footer -->
            <div style="position: absolute; bottom: 0; left: 0; right: 0; text-align: center;" class="text-xs text-slate-400">
        ...
        <div class="{{ !$loop->last ? 'page-break' : '' }}">
            ...
            <div style="padding-left: 16px;">
                <table class="grid-table">
                    <tr>
                        ...
                        <td class="value-cell font-bold" style="width: 45%;">{{ $employee->personalData?->last_name }} {{ $employee->personalData?->first_name }}</td>
            ...
            <div class="opinion-card">
                <div class="font-bold text-slate-900 mb-6 uppercase tracking-wider text-sm">{{ __('Medical Opinion') }}:</div>
                <table class="w-full mb-8">
                    <tr>
                        <td style="width: 33%;">
                            <div class="mb-4"><span class="checkbox"></span> <span class="font-bold">{{ __('Fit') }}</span></div>
                        </td>
                        <td style="width: 33%;">
                            <div class="mb-4"><span class="checkbox"></span> <span class="font-bold">{{ __('Unfit') }}</span></div>
                        </td>
                        <td>
                            <div class="mb-4"><span class="checkbox"></span> <span class="font-bold">{{ __('Fit with restrictions') }}</span></div>
                        </td>
                    </tr>
                </table>
                <div class="mb-4">
                ...
                <div class="text-base">
                    <span class="text-slate-500 font-bold">{{ __('Next examination due date') }}:</span> <span class="text-slate-300">..................................................</span>
                </div>
            </div>
