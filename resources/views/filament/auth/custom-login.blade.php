                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="code" wire:model="data.multiFactor.google_2fa.code" name="code" type="text"
                            ...
                            class="block w-full rounded-md border-0 py-2.5 px-3 text-slate-900 dark:text-white bg-white dark:bg-slate-800 shadow-sm ring-1 ring-inset ring-slate-300 dark:ring-slate-700 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-amber-600 sm:text-sm sm:leading-6 transition-all duration-200 text-center tracking-[0.5em] font-mono"
            ...
            <form wire:submit.prevent="authenticate" class="space-y-6">
                ...
                <div class="flex items-center">
                    <input id="remember" wire:model="data.remember" name="remember" type="checkbox"
                        class="h-4 w-4 rounded border-slate-300 text-amber-600 focus:ring-amber-600 dark:border-slate-600 dark:bg-slate-800">
